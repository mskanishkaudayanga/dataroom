  ...
  export default {
    ...
    data() {
      return {
        ...
        pushBackProcess: false,
      }
    },
    methods: {
      submitLead() {

        // if ( !this.pushBackProcess ) {
        //   this.pushBackProcess = true;
        //   return;
        // }
        ...
        axios.post(this.globalApiBaseUrl + '/canban/leadToWV', dataToSend)
            .then(
                (response) => {
                  if (response.data.status === 200) {
                    ...
                    this.notificationBannerInit('warning', 'Lead konnte nicht gespeichert werden');
                  }
                }
            )
            .catch(
  ...
  <div class="modal-wrapper" :class="{ active: isOpenModal }" v-if="isOpenModal" @click="closeDropdowns">
    ...
    <div class="modal-inner-wrapper">
      ...
      <div class="modal-header">
        <div class="title">Lead von Wiedervorlage zurück schicken</div>
      ...
      <div class="modal-body">
        ...
        <div class="actions">
          ...
          <Button type="report" @click="submitLead">Lead zurück <AnimateCircleIcon v-if="this.isLoading"></AnimateCircleIcon></Button>
        </div>
